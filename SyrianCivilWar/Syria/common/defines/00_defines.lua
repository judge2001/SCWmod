...
NDiplomacy = {
	...
	BASE_PEACE_TAKE_UNCONTROLLED_STATE_FACTOR = 10.0,-- Base factor for taking state you do not control in %
	...
	ER_JUSTIFY_AND_WAR_COST_FACTOR = 1.5,			-- Cost factor per nation at war with or justifying against
	...
	VOLUNTEERS_DIVISIONS_REQUIRED = 20,				-- This many divisons are required for the country to be able to send volunteers.
	...
	TENSION_NO_CB_WAR = 15,							-- Amount of tension generated by a no-CB war
...
NCountry = {
	...
	MAJOR_MIN_FACTORIES = 75,						-- need at least these many factories to become a major
...
NBuildings = {
	...
	BASE_FACTORY_REPAIR = 0.15,			-- Default repair rate before factories are taken into account
...
NTrade = {
	...
	BASE_TRADE_FACTOR = 250,				-- This is the base trade factor
